...
alexa=dir('082925_Cell3_Alexa594_0002*'); %Import images using filenames
caIndicator=dir('082925_Cell3_Fluo5F_0002*');

%Works best if limited to line scans taken close in time (e.g. only
%baseline sweeps or sweeps after a drug has taken effect)

stackNameAlexa='082925_Cell3_Alexa594'; %Name stack of images
stackNameCa='082925_Cell3_Fluo5F';      %Keep consistent with original
                                        %file names
                                        
expCondition='Baseline'; %e.g. Control, NBQX, CPP, etc.

rowsUsed=50:990; %Rows averaged to create fluorescence profiles, cut off
                 %end of image
minPeakProm=0.45;
